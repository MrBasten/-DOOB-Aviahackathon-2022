...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateTask(){//обновление задания
        long now = new Date().getTime();
        CurrentTask = getCurrentTask(now);
        formLayoutFromTask(now);
    }

    private Task getCurrentTask(long now){//определяет, какой задание выполняется следующим или сейчас
    ...
    private void showWaitingLayout(){//показывают отрисовку соответствующую ожиданию
    ...
    private void showDrivingLayout(boolean isLoaded){//показывают отрисовку соответствующую вождению
        findViewById(R.id.boardLayout).setVisibility(View.INVISIBLE);
...
//        resView.setAdapter(new PathAdapter(CurrentTask.GetPath()));
    ...
    private void showBoardingLayout(boolean isBoarding){//показывают отрисовку соответствующую посадке или высадке
        findViewById(R.id.waitingLayout).setVisibility(View.INVISIBLE);
        findViewById(R.id.driveLayout).setVisibility(View.INVISIBLE);
